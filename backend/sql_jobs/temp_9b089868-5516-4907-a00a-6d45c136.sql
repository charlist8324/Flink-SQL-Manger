...
CREATE TABLE `ka_user_sink` (
    ...
    'table.identifier' = 'testdb.ka_user_sink',
    'username' = 'root',
    'password' = 'Admin@900',
    'sink.properties.format' = 'json',
    'sink.properties.strip_outer_array' = 'false',
    'sink.label-prefix' = 'label_ka_user_sink',
...
CREATE TABLE `ka_address_sink` (
    ...
    'connector' = 'doris',
    'fenodes' = '192.168.31.234:8030',
    'table.identifier' = 'testdb.ka_address_sink',
    'username' = 'root',
    'password' = 'Admin@900',
    'sink.properties.format' = 'json',
    'sink.properties.strip_outer_array' = 'false',
    'sink.label-prefix' = 'label_ka_address_sink',
    'sink.check-interval' = '10000'
);
...
CREATE TABLE `ka_order_sink` (
    ...
    'connector' = 'doris',
    'fenodes' = '192.168.31.234:8030',
    'table.identifier' = 'testdb.ka_order_sink',
    'username' = 'root',
    'password' = 'Admin@900',
    'sink.properties.format' = 'json',
    'sink.properties.strip_outer_array' = 'false',
    'sink.label-prefix' = 'label_ka_order_sink',
    'sink.check-interval' = '10000'
);
